    ...
    <div className="text-white pb-[100px]">
      <div className="max-w-[800px] mt-[-225px] w-full h-screen mx-auto text-center flex flex-col justify-center ">
        ...
        <div className="flex justify-center items-center">
          <div classNAme>
            <p className="md:text-5xl sm:text-6xl text-4xl font-bold py-4 pt-[100px]">
              Stay up to date on your budget!
            </p>
          </div>
        </div>
        <p className="md:text-2xl text-xl font-bold text-gray-500 pt-[80px] sm:pt-[27px] lg:pt-[50px]">
